...
function appendData(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    var seller_value = document.createElement("p");
    seller_value.className = "title is-size-5 mt-2 has-text-grey-dark";
    seller_value.innerHTML = data[i].seller;
    var seller = document.createElement("p");
    seller.className = "subtitle is-size-6 pt-1 has-text-grey is-uppercase";
    seller.innerHTML = "Söluaðili";
